...
public class Aserver implements IXTSreceiver, IXTStransmitter, Runnable {
	static Aserver dummy = new Aserver();
	...
	private static final String msgString = "Hello, your message was received by Aserver. ";
	...
	public static final void main(final String[] args) throws Exception {
		...
		System.out.println("Aserver starting...");
		...
		if (trace) {
			...
			XTStrace.verbose("Aserver starting...");
		} else {
	...
	public final void received(final Message p, final Object uservalue,
		...
		XTStrace.verbose("msg=" + p.toString() + " msglen=" + p.length);
		XTStrace.verbose("msgq=" + q + " token=" + token);
		try {
