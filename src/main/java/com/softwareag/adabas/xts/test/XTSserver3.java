...
public class XTSserver3 implements IXTSreceiver, IXTStransmitter, Runnable {
	static XTSserver3 dummy = new XTSserver3();
	...
	public static final void main(final String[] args) throws Exception {
		...
		System.out.println("Starting XTSServer3 ...");
		...
		if (s != null) {
			...
			directory = new DefaultDirectory(); // KT.042899
			System.out.println("Directory: DefaultDirectory");
			if (trace) {
				XTStrace.verbose("Using user provided URL or Directory Server Services");
			}
